...
<p className=" has-text-primary">{props.day_2_date }</p>
...
is-2-desktop
  ...
  <div className="box">
  <div className="has-text-centered">
<p className=" has-text-primary">{props.day_3_date }</p>
...
<p className=" has-text-primary">{props.day_4_date }</p>
...
<ul  className="has-text-primary ">
<li className="is-size-3 has-text-centered mt-3" >{props.day_4_main_temp}°F</li>
<li>Humidity: {props.day_4_humidity}%</li>
<li>Wind: {props.day_4_wind_speed}mph
</li>
...
is-2-desktop
  ">
    <div className="box  ">
    <div className="has-text-centered ">
<p className=" has-text-primary">{props.day_5_date }</p>
...
<ul  className="has-text-primary ">
<li className="is-size-3 has-text-centered mt-3" >{props.day_5_main_temp}°F</li>
